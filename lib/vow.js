...
Promise.prototype = /** @lends Promise.prototype */ {
     ...
     * @param {Function} [constructError] Function to construct Error object
     * to reject Promise in case of timeout exceeding. If not specified,
     * standard `Error` object with 'timed out' message is created.
     * @returns {vow:Promise}
     *
     * @example
     * ```js
     ...
     * ```
     */
    timeout : function(timeout, constructError) {
        var defer = new Deferred(),
            timer = setTimeout(
                function() {
                    defer.reject(constructError ? constructError() : Error('timed out'));
                },
                timeout);
