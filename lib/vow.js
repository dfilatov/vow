...
Deferred.prototype = /** @lends Deferred.prototype */{
    ...
    /**
     * Resolve deferred with given val
     * @param {*} val
     */
    ...
    /**
     * Notify deferred with given val
     * @param {*} val
     */
    notify : function(val) {
...
Promise.prototype = {
    ...
    _notify : function(val) {
        this._promise._callCallbacks(this._progressCallbacks, val);
    },
...
var Vow = {
    ...
    invoke : function(fn) {
        try {
            return Vow.resolve(fn.apply(global, slice.call(arguments, 1))).promise();
        }
        catch(e) {
            return Vow.reject(e);
        }
    ...
    delay : function(val, timeout) {
        return Vow.resolve(val).promise().delay(timeout);
    },

    timeout : function(val, timeout) {
        return Vow.resolve(val).promise().timeout(timeout);
    }
};
