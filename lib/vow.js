...
Promise.prototype = {
    ...
    hasParent : function(parentPromise) {
        promises = arguments[1] || [];
        if (!this._parentPromise || promises.indexOf(this) !== -1) {
            return false;
        }
        promises.push(this);

        return this._parentPromise === parentPromise || this._parentPromise.hasParent(parentPromise, promises);
    },
