...
Promise.prototype = /** @lends Promise.prototype */ {
    ...
    /**
     * Returns `true` if promise has been resolved
     * @returns {Boolean}
     */
    isResolved : function() {
    ...
    /**
     * Returns `true` if promise has been fulfilled
     * @returns {Boolean}
     */
    ...
    /**
     * Returns `true` if promise has been rejected
     * @returns {Boolean}
     */
    isRejected : function() {
     ...
     * @param {Function} [onFulfilled] Callback that to be called with the value after promise has been fulfilled
     * @param {Function} [onRejected] Callback that to be called with the reason after promise has been rejected
     * @param {Function} [onProgress] Callback that to be called with the value after promise has been notified
    ...
    /**
     * Adds resolve reaction (to fulfillment and rejection both)
...
var Vow = {
    ...
    when : function(obj, onFulfilled, onRejected, onProgress, ctx) {
        return Vow.resolve(obj).then(onFulfilled, onRejected, onProgress, ctx);
    },
    ...
    fulfill : function(val) {
        return Vow.when(val, null, function(reason) {
            return reason;
        });
    },
    ...
    delay : function(val, timeout) {
        return Vow.resolve(val).delay(timeout);
    },

    timeout : function(val, timeout) {
        return Vow.resolve(val).timeout(timeout);
    }
};
