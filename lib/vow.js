...
Promise.prototype = /** @lends Promise.prototype */ {
    ...
    /**
     * Adds rejection reaction only. It is shortcut for `promise.then(null, onRejected)`.
     *
...
var vow = /** @exports vow */ {
     ...
     * It is equivalent to `new vow.Deferred()`.
     *
    ...
    /**
     * Creates a new promise. This method is a factory method for `vow:Promise` class.
     * It is equivalent to `new vow.Promise()`.
     *
    ...
    /**
     * Checks whether the given `value` is a instance of `vow.Promise`
     *
     * @param {*} value
     * @returns {Boolean}
     *
