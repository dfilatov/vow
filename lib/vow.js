...
var staticMethods = {
    ...
    all : function() {
        return vow.all.apply(this, arguments);
    },
...
var vow = /** @exports vow */ {
    ...
    all : function(promisesOrValues) {
        ...
        vow._forEach(promisesOrValues, onFulfilled, onRejected, keys);
    ...
    allResolved : function(promisesOrValues) {
        ...
        vow._forEach(promisesOrValues, onProgress, onProgress, keys);
    ...
    any : function(promisesOrValues) {
        ...
        vow._forEach(promisesOrValues, onFulfilled, onRejected);
