...
var undef,
    ...
    consolidate = function(object, deep) {
        return Vow.when(object, function (object) {
            if (typeof object !== "object" || object === null || object instanceof Date) {
                ...
                for (var i in object) {
                    if (Object.prototype.hasOwnProperty.call(object, i)) {
                        (function (i, value) {
                            synchronize = Vow.when(synchronize, function () {
                                return Vow.when(deep(value), function (value) {
                                    object[i] = value;
                                });
                            });
                        })(i, object[i]);
                ...
                return Vow.when(synchronize, function () {
                    return object;
                });
            }
        });
